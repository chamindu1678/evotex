						...
						<div class="col-sm-10 col-sm-offset-1">
							...
							if ($vquery->num_rows > 0) {
								...
								<div class="text-center">
									...
									<a href="#view" data-toggle="modal" class="btn btn-flat btn-primary btn-lg">View Vote</a>
								</div>
							...
							<form method="POST" id="ballotForm" action="submit_ballot.php">
								...
								while ($row = $query->fetch_assoc()) {
									...
									while ($crow = $cquery->fetch_assoc()) {
										...
										$candidate .= '
												<li>
													' . $input . '<button type="button" class="btn btn-primary btn-sm btn-flat clist platform" data-platform="' . $crow['platform'] . '" data-fullname="' . $crow['firstname'] . ' ' . $crow['lastname'] . '"><i class="fa fa-eye"></i> Candiate Number</button><img src="' . $image . '" height="100px" width="100px" class="clist"><span class="cname clist">' . $crow['firstname'] . ' ' . $crow['lastname'] . '</span>
												</li>
											';
									}
								...
								<div class="text-center">
									<button type="button" class="btn btn-success btn-flat" id="preview"><i class="fa fa-file-text"></i>
										Preview</button>
									<button type="submit" class="btn btn-primary btn-flat" name="vote"><i class="fa fa-check-square-o"></i>
										Submit</button>
								</div>
							</form>
							<!-- End Voting Ballot -->
