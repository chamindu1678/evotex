        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="candidates_add.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="position" class="col-sm-3 control-label">Party</label>
                ...
                <div class="form-group">
                    <label for="platform" class="col-sm-3 control-label">Candidate Number</label>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="candidates_edit.php">
                ...
                <div class="form-group">
                    <label for="edit_position" class="col-sm-3 control-label">Party</label>
                ...
                <div class="form-group">
                    <label for="edit_platform" class="col-sm-3 control-label">Candidate Number</label>
